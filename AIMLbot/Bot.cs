...
namespace AIMLbot
{
    ...
    public class Bot
    {
        public static System.Data.SQLite.SQLiteConnection SDB;
        ...
        /// </summary>
        public AIMLbot.Utils.XNode Graphmaster;
      ...
      public static StreamWriter str = new StreamWriter(Application.StartupPath + @"\t.txt");
      public static string GetTable(string hash)
      {
          return "CX"+hash.Substring(0,4);
      }
